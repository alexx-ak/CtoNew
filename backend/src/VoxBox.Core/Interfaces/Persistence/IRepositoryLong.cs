...
/// <summary>
/// Generic repository interface for entities with long IDs following SOLID principles:
...
public interface IRepositoryLong<T> where T : BaseEntityLong
{
    ...
    Task<T?> GetByIdAsync(long id, bool includeDeleted, CancellationToken cancellationToken = default);
